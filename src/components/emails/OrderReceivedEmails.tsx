...
const OrderReceivedEmails = ({
  ...
  const baseUrl =
    process.env.NODE_ENV === "development"
      ? "http://localhost:3000"
      : "https://casecobra-ecommerce.vercel.app";

  return (
    <Html>
      <Head />
      <Preview>Your order summary and estimated delivary date</Preview>
      <Body style={main}>
        <Container style={container}>
          <Section style={message}>
            <Img
              ...
              width={65}
              height={73}
              alt="delivery case snake"
              style={{ margin: "auto" }}
            />
            <Heading style={global.heading}>Thank you for the order!</Heading>
